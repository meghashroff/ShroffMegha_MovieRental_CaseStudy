...
<body>
    ...
    <div class="login_container">
        ...
        </div>    	<a href ="${pageContext.request.contextPath}/changePassword" style="font-size: medium;margin: 120px; text-decoration:none; text-align: center; color: white;">Change Password</a>
        <br><br>
