	...
	<body>
    	...
    	<div class="signIn_container">
    		<form:form name="signUpForm" id="signUpForm" method="post" action="createUser" modelAttribute="user" onsubmit="return validateUser()">
				...
				<br>
				<div>
					<form:label path="LastName">Last Name</form:label> <form:errors path="lastName" class="form-errors"/>
					<br>
				...
				<br>
				<div>
					<form:label path="username">User Name</form:label> <form:errors path="username" class="form-errors"/>
					<br>
				...
				<br>
				<div>
					<form:label path="phoneNo">Phone Number</form:label> <form:errors path="phoneNo" class="form-errors"/>
					<br>
